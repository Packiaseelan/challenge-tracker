...
class CustomCalendarView extends StatefulWidget {
  ...
  const CustomCalendarView({Key key, this.initialStartDate, this.initialEndDate, this.startEndDateChange})
      : super(key: key);
        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: AppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) || getIsInRange(date)
                                      ? AppTheme.buildLightTheme().primaryColor.withOpacity(0.4)
                                      : Colors.transparent
                                  : Colors.transparent,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date) ? AppTheme.buildLightTheme().primaryColor : Colors.transparent,
                              borderRadius: BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: DateTime.now().day == date.day && DateTime.now().month == date.month && DateTime.now().year == date.year
                                ? getIsInRange(date) ? Colors.white : AppTheme.buildLightTheme().primaryColor
                                : Colors.transparent,
